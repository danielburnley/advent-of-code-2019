defmodule MonitoringStationTest do
  ...
  defmodule GetVapourisedAsteroids do
    ...
    test "Example 1" do
      vapourised =
        [
          ...
          "#.#.#.#####.####.###",
          "###.##.####.##.#..##"
        ] |> Enum.map(fn line -> String.graphemes(line) end) |> MonitoringStation.get_vapourised_asteroids
    ...
    defp assert_vapourised(input, expected) do
      asteroids = Enum.map(input, fn line -> String.graphemes(line) end) |> MonitoringStation.get_vapourised_asteroids
